  ...
  return (
    <div className='login-right-section d-flex col-4 flex-column align-items-center'>
      ...
      <form className='d-flex flex-column justify-content-around mt-lg-3'>
        ...
        <div className='d-flex flex-column mt-3'>
          <label className='fw-bold fs-5' htmlFor='nickname'>
            您的暱稱
          </label>
          <input
            type='text'
        ...
        <div className='d-flex flex-column mt-3'>
          <label className='fw-bold fs-5' htmlFor='confirmPassword'>
            密碼確認
          </label>
          <input
            type='password'
        ...
        <NavLink
          to='/auth/login'
          className='fw-bold text-dark btn btn-outline-secondary mt-3'
        >
          登入
        </NavLink>
      </form>
